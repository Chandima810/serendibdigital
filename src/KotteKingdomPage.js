...
export default function KotteKingdomPage() {
  ...
  return (
    ...
    >
      <header className="header">
        <div className="brand">
          <img src={logo} alt="Kotte Kingdom logo" className="logo" />
          <h1>Kotte Kingdom</h1>
        </div>
        <p>Kotte Kingdom Digital Art Gallery</p>
        <p>
      ...
      <main>
        ...
        >
          ...
          <p>
            This collection presents minimalist digital artworks inspired by the
        ...
        >
          ...
          <p>
            <strong>Vision:</strong> To become a distinguished digital art
            gallery interpreting the heritage of the Kotte Kingdom through
            contemporary minimalist visual language.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Need structured support?</strong>{" "}
            <Link to="/legal">Visit Non Legal Support</Link>
          </p>
        </section>
      </main>

      <footer className="footer">
        <p>© Solutions WaterMinds — Kotte Kingdom Digital Art Gallery</p>
      </footer>
